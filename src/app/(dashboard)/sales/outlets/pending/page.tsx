...
import { getPendingOutlets } from "@/lib/api/sales";
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid grid-cols-3 gap-5">
        ...
        <KpiCard icon={CheckCircle2} iconColorClass="text-success" iconBgClass="bg-success-subtle" value={22} label="Approved This Month" />
        <KpiCard icon={XCircle} iconColorClass="text-danger" iconBgClass="bg-danger-subtle" value={3} label="Rejected This Month" />
      </div>
